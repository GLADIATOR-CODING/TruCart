      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--fg-faint)' }}>
            Join Tru<span className="text-brand font-bold">Cart</span> and start saving
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs font-bold uppercase tracking-widest mb-1.5 block" style={{ color: 'var(--fg-faint)' }}>Full Name</label>
          ...
          <div>
            <label className="text-xs font-bold uppercase tracking-widest mb-1.5 block" style={{ color: 'var(--fg-faint)' }}>Confirm Password</label>
            <div className="glass-tile flex items-center px-4 py-3 rounded-xl">
              <Lock className="w-4 h-4 mr-3 shrink-0" style={{ color: 'var(--fg-faint)' }} />
              <input
                type={showPass ? 'text' : 'password'}
